...
final class ChineseCalendar {
    ...
    private lazy var _startHour: Date = .distantPast
    private lazy var _endHour: Date = .distantFuture
    ...
    func update(time: Date, timezone: TimeZone, location: CGPoint?) {
        ...
        } else if timezone != _calendar.timeZone {
            updateYear()
        }
