...
func generateEntries<Entry: TimelineEntry & ChineseTimeEntry, Intent: WidgetConfigurationIntent>(chineseCalendars: [ChineseCalendar], watchLayout: WatchLayout, configuration: Intent) async -> [Entry] where Entry.Intent == Intent {
    var entries: [Entry] = []
